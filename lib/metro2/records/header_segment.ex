defmodule Metro2.Records.HeaderSegment do
  ...
  defstruct [
    ...
    innovis_program_identifier: %Alphanumeric{ required_length: 10 },
    equifax_program_identifier: %Alphanumeric{ required_length: 10 },
    experian_program_identifier: %Alphanumeric{ required_length: 5 },
